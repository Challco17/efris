<?php
	...
	*/
	...
	$db_username 	=	"efris";			// specify database username | default is "root"
	$db_password 	=	"efris2412";				// specify database password | leave as blank if database has no password set 
